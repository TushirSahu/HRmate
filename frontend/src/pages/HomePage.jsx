            ...
            <div className='text-center pb-12 md:pb-16'>
              ...
              <div className='max-w-3xl mx-auto'>
                <p
                  ...
                  data-aos-delay='150'
                >
                  AI-based candidate filtering uses machine learning to analyze
                  resumes and identify the best fit for a job. This process can
                  include analyzing text data, natural language processing and
                  conducting initial interviews, providing efficient and
                  unbiased results.
                </p>
                <div
